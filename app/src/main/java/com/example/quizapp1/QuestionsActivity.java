...
import com.example.quizapp1.Models.QuestionModel;
import com.example.quizapp1.databinding.ActivityQuestionsBinding;
...
public class QuestionsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        database.getReference().child("Sets").child(categoryName)
                .child("questions").orderByChild("setnum")
                .equalTo(set)
    ...
    private void resetTimer() {
        ...
        timer  = new CountDownTimer(30000,1000) {
            ...
            public void onFinish() {
                Toast.makeText(QuestionsActivity.this, "Time Over", Toast.LENGTH_SHORT).show();
            }
        };
